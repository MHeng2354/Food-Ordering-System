...
@section('content')
        ...
        <div class="container">
            <div class="row align-items-center gx-5">
                <div class="col-lg-8">
                    ...
                    <h1 class="display-5 fw-bold mb-4">Secure Payment</h1>
                    <p class="text-muted mb-0">Review your order and choose a payment method to complete your purchase.</p>
                </div>
    ...
    <div class="container py-4">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card border-0 shadow-sm overflow-hidden mb-4">
                        <div class="card-header bg-white border-0 py-3">
                            <h5 class="mb-0">Order Summary ({{ $totalQuantity }} items)</h5>
                        </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-check payment-option">
                                            ...
                                            <label class="form-check-label w-100 p-3 border rounded-3 cursor-pointer" for="credit_card" style="cursor: pointer;">
                                                <i class="bi bi-credit-card me-2 text-primary" style="font-size: 1.5rem;"></i>
                                                <div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check payment-option">
                                            ...
                                            <label class="form-check-label w-100 p-3 border rounded-3 cursor-pointer" for="debit_card" style="cursor: pointer;">
                                                <i class="bi bi-credit-card me-2 text-success" style="font-size: 1.5rem;"></i>
                                                <div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check payment-option">
                                            ...
                                            <label class="form-check-label w-100 p-3 border rounded-3 cursor-pointer" for="ewallet" style="cursor: pointer;">
                                                <i class="bi bi-wallet2 me-2 text-warning" style="font-size: 1.5rem;"></i>
                                                <div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check payment-option">
                                            ...
                                            <label class="form-check-label w-100 p-3 border rounded-3 cursor-pointer" for="bank_transfer" style="cursor: pointer;">
                                                <i class="bi bi-bank me-2 text-info" style="font-size: 1.5rem;"></i>
                                                <div>
                    ...
                    <div class="card border-0 shadow-sm sticky-top" style="top: 90px;">
                        <div class="card-body p-4">
                            ...
                            <div class="alert alert-info">
                                ...
                                <small>This is a prototype payment system. Clicking "Complete Payment" will register your order without actual payment processing.</small>
                            </div>
        ...
        @else
            <div class="alert alert-warning text-center py-5">
                ...
                <p class="text-muted mb-3">Your cart is empty. Please add items before proceeding to payment.</p>
    ...
    <script>
        ...
        paymentSubmitBtn.addEventListener('click', function() {
            ...
            const totalAmount = document.querySelector('.fw-bold.text-primary').textContent;
